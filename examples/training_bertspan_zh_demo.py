...
def main():
    ...
    parser.add_argument('--output_dir', default='./outputs/bertspan_model/', type=str, help='Model output directory')
    parser.add_argument('--best_model_dir', default='./outputs/bertspan_best_model/', type=str,
